    ...
    public function tabla()
    {
        ...
        return Datatables::of($corriente)
            ->addColumn('opcion', function ($ar) {
                ...
                if ($ar->paga + $ar->tarjeta_debito + $ar->tarjeta_credito == $ar->total_venta )
                {
                    return '
                        <div class="btn-group">
...
//        dd($venta);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($suma == $corriente->total_venta)
        {
            $corriente = CuentaCorriente::find($id);
            $corriente->estado = 'Cancelado';
            $corriente->save();
        }
        toastr()->error('El pago se ha afectuado correctamente!', 'Atención');
