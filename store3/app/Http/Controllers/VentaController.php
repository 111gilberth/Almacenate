...
use SisNacho\CuentaCorriente;
use SisNacho\CuentaCorrienteDetalle;
use SisNacho\Devolucion;
use SisNacho\Http\Requests\VentasFormRequest;
use SisNacho\Venta;
use SisNacho\ArqueoPago;
use SisNacho\DetalleVenta;
use SisNacho\Presupuesto;
use SisNacho\Persona;
use SisNacho\DetallePresupuesto;
use Carbon\Carbon;
use SisNacho\Arqueo;
    ...
    public function store(VentasFormRequest $request)
    {
        ...
        if ($request->tipo_venta == 'Cuenta Corriente')
        {
            ...
            if ($corriente == null)
            {
                ...
                {
                    $venta->num_comprobante =   $ultimo->idventa + $ultimo2->idcuenta_corriente;
                }
