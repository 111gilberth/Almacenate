...
//    USUARIOS
        ...
        Route::get('pedido', 'ReservaController@index')->name('reserva.index');
        Route::get('pedido-crear', 'ReservaController@create')->name('reserva.create');
        Route::get('pedido-tabla', 'ReservaController@tabla')->name('reserva.tabla');
        Route::get('pedido-ver/{id}', 'ReservaController@show')->name('reserva.show');
        Route::post('pedido-store', 'ReservaController@store')->name('reserva.store');
        Route::post('pedido-update/{id}', 'ReservaController@update')->name('reserva.detalle.update');
        Route::post('pedido-update-reserva/{id}', 'ReservaController@updateReserva')->name('reserva.reserva.update');
        Route::post('pedido-pago-reserva/{id}', 'ReservaController@updateReservaPago')->name('reserva.pago.update');
        Route::delete('pedido-borrar/{id}', 'ReservaController@destroy')->name('reserva.destroy');
