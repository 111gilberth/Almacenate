                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <h3>Listado de Clientes
                            <button  data-toggle="modal" data-target="#modal-agregar" class="btn btn-xs btn-success"><i data-toggle="tooltip" title="Agregar Cliente" class="fa fa-plus-circle"></i></button>
